...
1. Hide the buttons under Button Styles in the CleanPrint Settings page.</li>
2. Add the shortcode [cleanprint_button] to your theme's functions.php file (usually at/near the bottom):</li>
   <pre>add_shortcode('cleanprint_button', 'cleanprint_add_button');</pre>
3. Activate the button(s) in your HTML content, for example to add all 3 buttons:</li>
